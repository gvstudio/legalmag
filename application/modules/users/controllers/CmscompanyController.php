...
class Users_CmsCompanyController extends Rastor_Controller_Cms_ActionTable {

    protected $_modelClassName = 'Users_Model_Company';
    protected $_tableOptions = array(
        'rebuildParams' => false,
        'removeParams' => false,
        'pageRange' => 3
    );
    protected $_tableParams = array('id', 'name', 'login', 'email');
    protected $_tableColumns = array('id', 'Название', 'Логин', 'email');
