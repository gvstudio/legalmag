...
class Bootstrap extends Zend_Application_Bootstrap_Bootstrap {
    ...
    protected function _initAcl() {
        ...
        $acl->addRole(new Rastor_Acl_Role('company', 3));
        $acl->addRole(new Rastor_Acl_Role('jurist', 4));
        $acl->addRole(new Rastor_Acl_Role('member', 5));
    ...
    protected function _initZFDebug() {
        ...
        if (APPLICATION_ENV == 'development') {
            ...
            $cache = $this->getPluginResource('cachemanager')->getCacheManager()->getCache('database')->getBackend();
